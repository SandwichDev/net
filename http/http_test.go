...
func TestCmdGoNoHTTPServer(t *testing.T) {
	...
	wantSym := map[string]bool{
		...
		"github.com/SandwichDev/net/http.(*Client).do":           true,
		"github.com/SandwichDev/net/http.(*Transport).RoundTrip": true,

		// Verify these don't exist:
		"github.com/SandwichDev/net/http.http2Server":           false,
		"github.com/SandwichDev/net/http.(*Server).Serve":       false,
		"github.com/SandwichDev/net/http.(*ServeMux).ServeHTTP": false,
		"github.com/SandwichDev/net/http.DefaultServeMux":       false,
	}
...
func TestOmitHTTP2(t *testing.T) {
	...
	out, err := exec.Command(goTool, "test", "-short", "-tags=nethttpomithttp2", "github.com/SandwichDev/net/http").CombinedOutput()
	if err != nil {
...
func TestOmitHTTP2Vet(t *testing.T) {
	t.Parallel()
	goTool := testenv.GoToolPath(t)
	out, err := exec.Command(goTool, "vet", "-tags=nethttpomithttp2", "github.com/SandwichDev/net/http").CombinedOutput()
	if err != nil {
