...
func (t *Transport) RoundTrip(req *Request) (*Response, error) {
	...
	failure = js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		success.Release()
		failure.Release()
		errCh <- fmt.Errorf("github.com/SandwichDev/net/http: fetch() failed: %s", args[0].Get("message").String())
		return nil
	})
...
var errClosed = errors.New("github.com/SandwichDev/net/http: reader is closed")
